...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{chromacorr.png}
...
The observations from the previous sections inform us that several approaches may be successful: interpolation between known and unknown values.
...
%TODO multi-band GMM with posterior would be ideal but is not tractable
...
%TODO cite sklearn, pandas, numpy, scipy, matplotlib
